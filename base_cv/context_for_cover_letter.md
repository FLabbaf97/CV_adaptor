...
**Ideal working environment.** I am highly interested (but not limited) in working within healthcare and med-tech companies where I can apply my technical skills and contribute to the team. I also like to work in fast-paced startups, research groups, and R&D teams where I can learn about the business and the impact of my work. I am also interested in working in a mission-driven company where I can make a difference. Roles that combine production ML, LLM integration, and rigorous software engineering—especially in regulated or high-stakes domains—are a strong fit for me.
...
**Summary:** Worked as a software engineer and machine learning engineer in a health-tech startup, developing machine learning components for an AI-enabled Software as a Medical Device (SaMD) platform. Led end-to-end platform development and collaborated with cross-functional engineering and regulatory teams to support development of clinical-grade AI software.
...
- Accelerated experimentation and development velocity through LLM-assisted workflows while preserving traceability
...
- **Regulated healthcare AI:** SaMD development, QMS exposure, validation-oriented ML, traceability, intended-use boundaries
...
- **LLM and modern AI:** Hugging Face, RAG, prompt engineering, LLM post-processing, AI agents, MCP, AI-assisted software development
